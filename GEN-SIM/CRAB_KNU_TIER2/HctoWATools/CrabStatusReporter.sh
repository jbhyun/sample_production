...
do
 ...
 crab status -d ${ForgePath}/${Process}/crab_projects/crab_${Process}_CMSSW_7_1_18_GEN-SIM/ | grep -E "Task|idle|fail|running|finished|transfer|unsubmitted|Output dataset" >> ${FileName}
