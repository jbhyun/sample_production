...
do
 ...
 TargetDir=${ForgePath}/${Process}/crab_projects/crab_${Process}_CMSSW_7_1_18_GEN-SIM/
 if [[ ! -d ${TargetDir} ]]; then echo "Target Dir doesn't exist for ${Process}, skipping"; continue; fi 
 crab resubmit -d ${ForgePath}/${Process}/crab_projects/crab_${Process}_CMSSW_7_1_18_GEN-SIM/ 
done
