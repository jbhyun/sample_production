...
do
 ...
 crab status -d ${ForgePath}/${Process}/crab_projects/crab_${Process}_CMSSW_8_0_21_MiniAOD/ | grep -E "Task|idle|fail|running|finished|transfer|unsubmitted|Output dataset" >> ${FileName}
